...
$adbadf3fc7998dca$var$remove = {
};
$adbadf3fc7998dca$var$source = {
};
$adbadf3fc7998dca$var$target = {
};
$adbadf3fc7998dca$var$remove = {
};
$adbadf3fc7998dca$var$target = new Proxy({
}, {
    get: (obj, prop)=>{
        return obj[prop];
    },
...
$adbadf3fc7998dca$var$source = new Proxy({
}, {
    get: (obj, prop)=>{
        return obj[prop];
    },
    ...
    return new Promise((resolve, reject)=>{
        try {
            resolve({
                ...
                success: true,
                message: {
                    target: $adbadf3fc7998dca$var$target,
                    source: $adbadf3fc7998dca$var$source,
                    remove: $adbadf3fc7998dca$var$remove
                }
            });
        } catch (e) {
            resolve({
...
let $adbadf3fc7998dca$var$close = (task)=>{
    return new Promise(async (resolve, reject)=>{
        try {
            $1b18bf45954afeed$export$9099ad97b570f7c($adbadf3fc7998dca$var$source[`${task}`]) ? delete $adbadf3fc7998dca$var$target[`${task}`] : $adbadf3fc7998dca$var$remove[`${task}`] = true;
            resolve({
                status: 'ok',
                success: true,
                message: ''
...
let $adbadf3fc7998dca$var$wait = (task, call)=>{
    return new Promise(async (resolve, reject)=>{
        try {
            if (!$1b18bf45954afeed$export$9099ad97b570f7c($adbadf3fc7998dca$var$target[`${task}`])) {
                $adbadf3fc7998dca$var$target[`${task}`] = {
                    call: call
                };
                resolve(true);
            } else if ($1b18bf45954afeed$export$9099ad97b570f7c($adbadf3fc7998dca$var$source[`${task}`])) {
                $adbadf3fc7998dca$var$target[`${task}`] = {
                    call: call
                };
                resolve(true);
            } else {
                console.log(`  ${$dfe731a04a9a6860$export$9099ad97b570f7c('moon')[2][1]}`, $adbadf3fc7998dca$var$source[`${task}`][0]['task']);
                $adbadf3fc7998dca$var$target[`${task}`] = {
                    call: call
                };
                let item = $adbadf3fc7998dca$var$target[`${task}`];
                while(!$1b18bf45954afeed$export$9099ad97b570f7c($adbadf3fc7998dca$var$source[`${task}`][0])){
                    for(let i = 0; i < item.length; i++)await item[i].call({
                        message: $adbadf3fc7998dca$var$source[`${task}`][0]['message'],
                        task: $adbadf3fc7998dca$var$source[`${task}`][0]['task'],
                        call: $adbadf3fc7998dca$var$source[`${task}`][0]['call']
                    });
                    $adbadf3fc7998dca$var$source[`${task}`].shift();
                }
                if ($adbadf3fc7998dca$var$remove[`${task}`]) {
                    delete $adbadf3fc7998dca$var$target[`${task}`];
                    delete $adbadf3fc7998dca$var$remove[`${task}`];
                }
                delete $adbadf3fc7998dca$var$source[`${task}`];
                resolve(true);
            }
        } catch (e) {
            console.log('error', e);
    ...
    return new Promise((resolve, reject)=>{
        try {
            if ($1b18bf45954afeed$export$9099ad97b570f7c($adbadf3fc7998dca$var$target[`${task}`])) {
                ...
                $adbadf3fc7998dca$var$source[`${task}`] = {
                    message: message,
                    task: task,
                    call: call
                };
                ...
                while(!$1b18bf45954afeed$export$9099ad97b570f7c($adbadf3fc7998dca$var$source[`${task}`][0])){
                    $adbadf3fc7998dca$var$target[`${task}`].forEach((item)=>{
                        item.call({
                            message: $adbadf3fc7998dca$var$source[`${task}`][0]['message'],
                            task: $adbadf3fc7998dca$var$source[`${task}`][0]['task'],
                            call: $adbadf3fc7998dca$var$source[`${task}`][0]['call']
